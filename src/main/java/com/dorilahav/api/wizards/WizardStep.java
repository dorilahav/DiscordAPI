...
public class WizardStep<E extends GenericMessageEvent, V> {
    ...
    private final WizardPointer<? extends WizardRunnable<E, V>>
            pointer;
    ...
    public WizardStep(String name, AEmbed embed, Class<E> eventClass, Class<V> valueClass, WizardPointer<? extends WizardRunnable<E, V>> pointer) {
        this.name = name;
        this.embed = embed;
